            ...
            <div className="hidden lg:flex w-1/5 md:w-1/4 items-center justify-end space-x-4 ">
              ...
              {/* <button className="btn btn-ghost btn-circle">
                <div className="indicator">
                  ...
                  <span className="badge badge-xs bg-B indicator-item"></span>
                </div>
              </button> */}
              ...
              <Link
                href="/login"
                className="hidden lg:flex lg:justify-center space-x-12 items-center border bg-gradient-to-br from-DB to-LB  p-2 rounded-lg text-white w-28 "
              >
                เข้าสู่ระบบ
              </Link>
