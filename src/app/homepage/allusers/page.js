        ...
        {/* <button className="btn bg-white w-full text-blue-500 text-lg" onClick={()=>{
          ...
          <h1 className="text-lg text-white">ผู้มีความเสี่ยง</h1>
            ...
            <div className="form-control rounded-md bg-white p-2">
              ...
              <label className="label cursor-pointer">
                <span className="label-text  text-md">ทำแบบประเมินก่อนเสร็จแล้ว</span>
                <input
                  type="checkbox"
            ...
            <div className="form-control rounded-md bg-white p-2">
              <label className="label cursor-pointer">
                <span className="label-text  text-md">ทำแบบประเมินหลังเสร็จแล้ว</span>
                <input
                  type="checkbox"
            ...
            <div className="form-control rounded-md bg-white p-2">
              <label className="label cursor-pointer">
                <span className="label-text  text-md">ทำแบบประเมินยังไม่ครบ</span>
                <input
                  type="checkbox"
        ...
        {usersReduce.length > 0 &&
          usersReduce.filter((
            ...
            if(!userPreQuiz && !userPostQuiz && !userUnCompleteQuiz){
              return true
            }else if(userPreQuiz && userPostQuiz && userUnCompleteQuiz){
              return true
              ...
              return user.preQuiz === false || user.postQuiz === false
            }
            ...
            >
              ...
              {!user.postQuiz &&  (
                <>
                 {user.mayBeRisk === "high"  && (<span className="badge border-2  p-2 ">• อาจจะมีความเสี่ยงสูง</span>)}
              {user.mayBeRisk === "medium"  && (<span className="badge border-2  p-2 ">• อาจจะมีความเสี่ยงปานกลาง</span>)}
              {user.mayBeRisk === "low"  && (<span className="badge border-2  p-2 ">• อาจจะมีความเสี่ยงต่ํา</span>)}    
                </>
              )}
              {user.preRq20 === 0 && user.preRq3===0 && user.postRq3===0 && user.postRq20===0 && <span className="badge border-2  p-2 ">ยังไม่ได้ประเมิน</span>}
